...
async function getTranches(questionId) {
  try {
    const response = await fetch(
      `http://127.0.0.1:3008/questions/${questionId}/tranches`
    );
    if (!response.ok) {
...
function PopUpEditAnswerSlots({
  ...
  const addTranche = () => {
    setTranches([
      ...tranches,
      { min: "", max: "", value: "", recommandation: "", plafond: "" },
    ]);
  };
                ...
                <div key={index} style={styles.trancheRow}>
                  <div style={styles.inputGroup}>
                    ...
                    <input
                      ...
                      value={tranche.min}
                      onChange={(e) =>
                        updateTranche(index, "min", e.target.value)
                      }
                      placeholder="0"
                    />
                    {errors[`${index}-min`] && (
                  ...
                  <div style={styles.inputGroup}>
                    ...
                    <input
                      ...
                      value={tranche.max}
                      onChange={(e) =>
                        updateTranche(index, "max", e.target.value)
                      }
                      placeholder="100"
                    />
                    {errors[`${index}-max`] && (
                  ...
                  <div style={styles.inputGroup}>
                    ...
                    <input
                      ...
                      value={tranche.value}
                      onChange={(e) =>
                        updateTranche(index, "value", e.target.value)
                      }
                      placeholder="Points"
                    />
                    {errors[`${index}-value`] && (
                  ...
                  <div style={styles.inputGroup}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateTranche(index, "plafond", e.target.value)
                      }
                      placeholder="Max"
                    />
                  </div>
                  ...
                  {errors[`${index}-range`] && (
                    <span style={styles.errorTextFull}>
                      {errors[`${index}-range`]}
                    </span>
                  )}
                  ...
                  <div style={styles.fullWidthInput}>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        updateTranche(index, "recommandation", e.target.value)
                      }
