...
async function getQuestionnaire(idQuestionnaire) {
  try {
    const response = await fetch(
      `${API_URL}/questionnaire/${idQuestionnaire}`
    );
    if (!response.ok) {
...
async function updateQuestionnaire(
  ...
  try {
    const response = await fetch(
      `${API_URL}/updateQuestionnaire/${idQuestionnaire}`,
      {
        method: "PUT",
        headers: {
...
async function getReco(idQuestionnaire) {
  try {
    const response = await fetch(
      `${API_URL}/recommandations/${idQuestionnaire}`
    );
    if (!response.ok) {
...
function Questionnaire() {
  ...
  const handleSaveSection = async (newSection, questionnaire_id = id) => {
    try {
      ...
      // setIsCreating(true)
      const response = await fetch(`${API_URL}/createSection`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleSaveReco = async (newReco, questionnaire_id = id) => {
    try {
      ...
      const response = await fetch(`${API_URL}/createreco`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          // Ajoute l'auth si nécessaire
