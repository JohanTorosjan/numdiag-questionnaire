...
function SectionUpdateForm ({section, onChange}) {
   return (
    <form>
      ...
      <input type="text" name="label" id="sectionTitle" required value={section.label} onChange={onChange}/>
      <label htmlFor="sectionDescription">Description :</label>
      <input type="text" name="description" id="sectionDescription" required value={section.description ? section.description : '' } onChange={onChange} />
